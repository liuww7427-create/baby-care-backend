import { Maybe, PromiseOrValue, AsyncIterableIteratorOrValue } from '@envelop/types/utils';
import { ExecuteFunction, ParseFunction, ValidateFunction, ValidateFunctionParameter, SubscribeFunction, ExecutionResult, ExecutionArgs } from '@envelop/types/graphql';
import { Plugin } from '@envelop/types/plugin';
export declare type DefaultArgs = Record<string, unknown>;
export declare type SetSchemaFn = (newSchema: any) => void;
/**
 ...
 */
export declare type OnPluginInitEventPayload<PluginContext extends Record<string, any>> = {
    /**
 ...
 */
export declare type OnPluginInitHook<ContextType extends Record<string, any>> = (options: OnPluginInitEventPayload<ContextType>) => void;
/** onPluginInit */
 ...
 */
export declare type TypedSubscriptionArgs<ContextType> = Omit<ExecutionArgs, 'contextValue'> & {
    contextValue: ContextType;
};
/**
